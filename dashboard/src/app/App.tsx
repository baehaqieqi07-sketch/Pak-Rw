...
import { ActivityPage, BackupPage, ChannelManagerPage, CommandCenterPage, LogsPage, PermissionCenterPage, RoleManagerPage, SettingsPage, BannerManagerPage, DataIdServerPage, KtpWargaPage, AfkVoicePage } from "../pages/SystemPages";
    ...
    <DashboardContext.Provider value={{ data, picker, pickerLoading, refresh, refreshPicker, notify }}>
      <Routes>
        <Route element={<AppShell data={data} />}>
          ...
          <Route path="afk-voice" element={<AfkVoicePage />} />
