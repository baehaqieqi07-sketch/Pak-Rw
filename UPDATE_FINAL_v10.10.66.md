...
Semua template aktif menggunakan icon URL custom emoji `1516424353934348299` dan teks `<a:Desa_Tulus2:1518502350363430932> DESA TULUS | ...`. Custom emoji tidak ditulis mentah di footer karena Discord footer tidak merender syntax emoji; emoji digunakan sebagai `iconURL` agar benar-benar tampil.
